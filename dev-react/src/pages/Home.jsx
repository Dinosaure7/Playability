function Home() {
    ...
        <article className="bg-[var(--primary-color-opacity)] min-h-32 p-6 lg:p-12 rounded-xl mt-4 mr-10 ml-10 lg:mt-11 lg:mr-32 lg:ml-32 lg:min-h-44" aria-labelledby="Le jeu vidéo est une expérience universelle">
    ...
        </article>
        <article className="flex items-center bg-[var(--nuance3-secondary-opacity)] min-h-32 p-6 lg:p-12 rounded-xl mr-10 ml-10  lg:mt-11 lg:mr-32 lg:ml-32 lg:min-h-44"aria-labelledby="statistiques">
          <h2 className="text-4xl lg:text-8x1" aria-label="Pourcentage de personnes avec un handicap freinés dans l'accès au jeu">91%</h2>
    ...
        </article>
        <article className="bg-[var(--nuance2-secondary-opacity)] min-h-32 p-6 lg:p-12 rounded-xl mb-14 mr-10 ml-10 lg:mt-11 lg:mr-32 lg:ml-32 lg:min-h-44">
